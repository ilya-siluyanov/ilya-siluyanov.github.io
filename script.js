...
function displayWord(word) {
    ...
    console.log(correctCount, allCount);
    if (allCount == 0) {
        resultPercentage.innerText = "0%";
    } else {
        resultPercentage.innerText = Math.round(correctCount / allCount * 100) + "%";
    }
    resultPercentage.innerText+=" от числа представленных слов "+"("+allCount+")";
